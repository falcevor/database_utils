...
namespace DatabaseScriptGeneratorConsole
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var prms = new Parameter[] { new Parameter() { Name = "p_column1", Type = "INTEGER" }, new Parameter() { Name = "p_column2", Type = "VARCHAR(2000)" } };
            ...
            var parameters = new GeneratorParameters()
            {
                ...
                FilterParameters = new Parameter[] { new Parameter() { Name = "p_column3", Type = "INTEGER" } }
            };
